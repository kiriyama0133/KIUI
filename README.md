...
| 组件 | vcpkg 包名 | 跨平台支持 | 备注 |
|------|-----------|-----------|------|
| **窗口管理** | `glfw3` | ⭐⭐⭐⭐⭐ 极佳 | 现代 OpenGL/GLES 窗口创建的首选 |
| **图形 API** | `angle` | ⭐⭐⭐⭐⭐ 极佳 | 在 Windows 上提供 GLES 3.0 支持 |
| **布局引擎** | `yoga` | ⭐⭐⭐⭐⭐ 极佳 | Facebook 开源，C++ 绑定非常成熟 |
| **字体加载** | `freetype` | ⭐⭐⭐⭐⭐ 极佳 | 几乎所有 UI 库的底层字体解析器 |
| **文字排版** | `harfbuzz` | ⭐⭐⭐⭐⭐ 极佳 | 负责处理字间距、连笔、复杂语系 |
| **图片加载** | `stb` | ⭐⭐⭐⭐⭐ 极佳 | 轻量级单头文件库，建议用这个代替重量级的 libpng/jpeg |
